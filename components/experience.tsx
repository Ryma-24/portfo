...
const Experiences = () => {
 ...
 <>
    ...
    <div className=" flex flex-col items-center justify-center mt-10 h-full space-y-10 md:space-y-0 auto md:mt-auto md:flex md:flex-row md:items-center md:space-x-5 md:justify-center md:w-screen md:h-screen  md:text-white md:overflow-auto">
      <Card className=" w-64 h-72 md:w-80 md:h-64  bg-slate-400 shadow-white shadow-md hover:shadow hover:scale-125 duration-200">
        <CardHeader>
      ...
      <Card className="w-64 h-72 md:w-80 md:h-64 bg-slate-400 shadow-white shadow-md  hover:shadow hover:scale-95 duration-200">
        <CardHeader>
          <CardTitle className="flex">
